...
func Test(t *testing.T) {
	...
	require.NotEmpty(t, db, "PG_DB environment variable must be set for ClickHouse tests")
	host := env.GetEnvStr("PG_HOSTS", "")
	require.NotEmpty(t, host, "PG_HOSTS environment variable must be set for ClickHouse tests")
